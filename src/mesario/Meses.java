...
public interface Meses {
    //atributos finales van en mayusculas
    ...
    String [] NOMBRES_MESES = {"", "Enero","Febrero", "Marzo", "Abril","Mayo","Junio",
        "Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"};//upper snake_case

}
/**
 * Meses es una interface que imp0lementa atributos finales
 */